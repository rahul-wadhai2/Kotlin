 ...
 *  @param url URL of the image associated with the message.
 *  @param readBy List of user IDs who have read the message.
 *  @param deliveredAt Timestamp when the message was delivered.
 *  @param readAt Timestamp when the message was read.
 */
